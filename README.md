...
После того как вы выполнили задачу еще раз проверьте что ваша ветка использует последние
...
- От имени 1-го пользователя оставьте отзыв, от имени 2-го оставьте отзыв.
